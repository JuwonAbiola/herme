...
export class MyApp {
  ...
  constructor(public splashScreen: SplashScreen, public statusBar: StatusBar, public platform: Platform, public app: App, public alertCtrl: AlertController
    ...
    this.pages = [
      { icon: "timer", name: 'Delivery History', component: HomePage },
      { icon: "ios-card", name: 'Payments', component: LoginPage },
      { icon: "ios-pricetags", name: 'Promotions', component: SignupPage },
    ...
    this.im = { img: "assets/imgs/kal.png", username: "Celilia Jones", component: ProfilePage };
